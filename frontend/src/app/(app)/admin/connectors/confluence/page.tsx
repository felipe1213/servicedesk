      ...
      <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 8, padding: 24, marginBottom: 24 }}>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <label style={{ marginRight: 16 }}>
            <input type="radio" value="space" checked={form.syncType === 'space'} onChange={() => setForm(f => ({ ...f, syncType: 'space' }))} /> Full Space
          </label>
          <label>
            <input type="radio" value="pagetree" checked={form.syncType === 'pagetree'} onChange={() => setForm(f => ({ ...f, syncType: 'pagetree' }))} /> Page Tree
          </label>
        </div>
